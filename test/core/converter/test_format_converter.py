...
from core.converter.format_converter import PandasFormatConverter
...
class TestPandasFormatConverter(TestCaseCompare):
    ...
    def setUpClass(cls):
        ...
        cls.input_folder = cls.input_folder / 'core' / 'converter' / 'format_converter'
        cls.output_folder = cls.output_folder / 'core' / 'converter' / 'format_converter'
